...
head = hr.Head(ind="    ")
head.append(hr.Meta(ind="        ", charset="UTF-8"))
head.append(hr.Title("PythonClass = Revision 1087:", ind="        "))

page.append(head)

body = hr.Body(ind="    ")

body.append(hr.H(2, "PythonClass - Example", ind="        "))

body.append(hr.P("Here is a paragraph of text -- there could be more of them, "
                 "but this is enough  to show that we can do some text", ind="        ",
                 style="text-align: center; font-style: oblique;"))

body.append(hr.Hr(ind="        "))

list = hr.Ul(ind="        ", id="TheList", style="line-height:200%")

list.append(hr.Li("The first item in a list", ind="            "))
list.append(hr.Li("This is the second item", ind="            ", style="color: red"))

item = hr.Li(ind="            ")
item.append("And this is a ")
item.append(hr.A("http://google.com", "link", ind="                "))
item.append("to google")
